---
description: Abre um PR em draft a partir do plano/contexto atual — cria branch, empty commit, title e body do SPEC. Se bloqueado pra criar o PR, instrui o usuario comando por comando. Ao final, cria worktree via /git-worktree e devolve o root pra branch principal.
