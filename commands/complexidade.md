---
description: Mede complexidade ciclomática apenas nos arquivos alterados (vs base ou staged). Report inline com threshold configurável. Com --fix, oferece refactor. Nunca commita.
